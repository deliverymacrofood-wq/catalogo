...
## Layout atualizado
- Nova seção de Produtos em Destaque no catálogo.
- Destaques podem ser marcados no painel administrativo ao cadastrar/editar produto.
- Em telas pequenas, a seção vira uma faixa horizontal deslizável.
- Execute o supabase.sql para criar a coluna is_featured.
