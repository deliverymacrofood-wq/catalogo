...
async function init(){
  ...
  if(!session){$('ordersApp').innerHTML='<div class="panel orders-login"><h2>📦 Meus pedidos</h2><p>Entre na sua conta para acompanhar seus pedidos.</p><a class="primary" href="login/">Entrar na minha conta</a></div>';return;}
